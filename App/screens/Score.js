...
export default function Score({navigation,route}) {
  ...
  return (
     ...
     */
      ...
      <TouchableOpacity style={{backgroundColor:"#7400b8",borderRadius:5,width:Dimensions.get("screen").width/1.5,height:35,justifyContent:'center',display:'flex',alignSelf:'center',marginTop:50}}
        onPress={() => {
         navigate('QuizIndex');
        }}
      >
